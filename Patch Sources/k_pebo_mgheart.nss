// Prototypes
//This was created using a Decompilation from DeNCS with slight modifications, 
		...
		if ((int7 == 1)) {
			...
			if (((nGlobal == 0) && (int3 == 10))) {
				...
				if (((nGlobal == 40) && (int3 == 20))) {
					...
					//My additon right here: 
					//Adds a default behavior to avoid getting stuck
					//Simply return the player to the Ebon Hawk
					else {
